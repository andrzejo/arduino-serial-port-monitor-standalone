...
public class Serial implements SerialPortEventListener {
    ...
    public static boolean touchForCDCReset(String iname) throws SerialException {
        ...
        try {
            ...
            throw new SerialException("Error touching serial port ''{0}''.", e);
        } finally {
    ...
    public Serial(String iname, int irate) throws SerialException {
        this(iname, irate, 'N', 8, 1, false, false);
    }
    ...
    protected Serial(String iname, int irate, char iparity, int idatabits, float istopbits, boolean setRTS, boolean setDTR) throws SerialException {
        ...
        if (port == null) {
            throw new SerialNotFoundException(format("Serial port ''{0}'' not found. Did you select the right one from the Tools > Serial Port menu?", iname));
        }
    }
